A test statistic used when working with *proportions*, or when the population [[Standard Deviation|standard deviation]] is known.
$$Z=\frac{\hat{p} - p_{0}}{\sqrt{\frac{\hat{p}(1-\hat{p})}{n}}}$$
**Parameters:**
- *n* - Sample amount of the tracked variable
...
>proportions_ztest(n, nobs, value=x, alternative)
>```
