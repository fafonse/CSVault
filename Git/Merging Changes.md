When merging changes from one branch to another, you first create a [[Pull Requests|pull request]], then go through and check for conflicts. If you're all good, you can go ahead and merge the branches. 
